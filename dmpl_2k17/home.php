<html>
    ...
    <body onload="begin()">
        <div class="hdr1">
            <div class="logo"><img src="logo/dmpl.png" width="50%" height="100%"></div>
            <div class="logodiv">DMPL 2K17</div>
        </div>
        <div class="hdr2">AUCTION&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp</div>
        <div class="hdr3">
            <ul>
            <li class="menu" id="rules" onclick="alert('Yet to be updated!')">RULES</li>
            <li class="menu" onclick="alert('Yet to be updated!')">SQUAD</li>
            ...
            <div class="col_mid">
                <div class="col_mid_top_view">
                    ...
                    <div class="col_mid_top_view_image">
                        <img src="images/2.jpg" class="pic_update" id="auction_player">
                    </div>
